...
--use the below query in power BI for inserting calucated tables for answering question 3 and 4
...
--use the below query in power BI for inserting calucated tables for answering question 1 and 2
